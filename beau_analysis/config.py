...
RAW_DATA_FOLDER = os.getenv('RAW_DATA_FOLDER', 'app/import/raw_log')
...
BEAU_FOLDER = os.getenv('BEAU_FOLDER', 'beau_analysis/data')
...
if __name__ == "__main__":
    ...
    print("Beau extract data:", BEAU_FOLDER)

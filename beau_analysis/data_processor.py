...
if __name__ == "__main__":
    from config import PROCESSED_DATA_FOLDER, ACTIVITY_FOLDER, BEAU_FOLDER, RAW_DATA_FOLDER
    
    processor = DataProcessor(PROCESSED_DATA_FOLDER, ACTIVITY_FOLDER, BEAU_FOLDER, RAW_DATA_FOLDER)
